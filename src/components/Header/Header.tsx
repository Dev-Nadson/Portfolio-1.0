...
function Header() {
    return (
        <header className="h-200 md:h-[95vh] border shadow-xl shadow-purple-300 border-purple-700 rounded-3xl flex flex-col">
            ...
            <section className="px-3 md:px-15 border flex flex-1 items-center justify-center gap-4">
                ...
                <div className="flex items-center justify-center">
                    <div className="flex flex-col gap-30 items-center md:items-start">
                        ...
                        <div className="">
                            <a href="#projetos" className=" flex w-fit bg-purple-300  py-4 px-18 rounded-full hover:shadow-lg hover:shadow-purple-400 hover:ring hover:ring-purple-50 text-2xl font-bold transition-all duration-300 ease-in-out transform hover:scale-110">Veja meus Projetos</a>
                        </div>
                    </div>
